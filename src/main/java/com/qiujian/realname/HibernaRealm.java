...
public class HibernaRealm extends AuthorizingRealm{
    @Override
    public String getName(){return "HibernaRealm";}
    @Autowired
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principalCollection) {
        ...
        //查询当前用户的角色和权限
        List<String> jss = userService.getRoleDtoByName(userName);
        List<String> qxs = userService.getPermissionDtoByName(userName);
        //封装用户的角色和权限
