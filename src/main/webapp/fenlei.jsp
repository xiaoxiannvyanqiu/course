...
<div class="search_list">
    <div class="page">
        ...
        <div class="side_left">
            <dl class="side_list">
                <dt>搜索结果分类</dt>
                <dd class="item_on"><a href="" title="手机回收价格评估"><b
            ...
            <%-- <div class="brand">
                ...
                <div class="brand_main">
                    ...
                    <c:forEach items="${brandList}" var="brand">
                        <a href="<%=basePath%>/fenlei.do?brandId=${brand.brand_id}">${brand.brand_name}</a>
                       <em>|</em>
                     </c:forEach>
                   ...
                   <%--  <a href="<%=basePath %>/phoneDetail.do?phoneId=${phone.phone_id}"> --%>
                        <div class="pic_list_box">
                            <div class="pic_list_img"><a href="" title="iphone 7回收价格评估"><img
                                    src="http://img.ihuigo.com/goods/739b3910f020832305a94a6a96eec952.jpg" width="180"
                                    height="135" alt="iphone 7闲置回收价格评估"/></a></div>
                             
                            <p class="name">${phone.phone_name}</p>
                            <!--<p class="price">回收价：<em>￥3080</em></p>-->
                            <p class="pinggu"><a href="<%=basePath %>/phoneDetail.do?phoneId=${phone.phone_id}" title="在线评估iphone 7回收价格"><!--去评估--></a>
                            </p>
