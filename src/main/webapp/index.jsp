...
<div class="header">
    <div class="page">
        ...
        <div class="nav">
            <a title="闲置二手手机回收估价" href="<%=basePath%>/show.do" class="on">
...
<div class="search_list">
    <div class="page">
        ...
        <div class="side_left">
            <dl class="side_list">
                <dt>搜索结果分类</dt>
                <dd class="item_on"><a href="/phone/all" title="手机回收价格评估"><b
        ...
        <div class="side_right">
            ...
            <div class="brand">
                ...
                <div class="brand_main">
                    <div class="brand_hot">
                    <c:forEach items="${phoneDtoList}" var="phone">
                        <a href="<%=basePath%>/phone/leixing?phId=${phone.phId}">${phone.phName}</a>
                       <em>|</em>
                     </c:forEach>
            ...
            <div class="search_main">
                ...
                <dl class="pic_list">
                    <c:forEach items="${leiXingByList}" var="leixing">
                    <dd>
                   <%--  <a href="<%=basePath %>/phoneDetail.do?phoneId=${phone.phone_id}"> --%>
                        <div class="pic_list_box">
                            <div class="pic_list_img"><a href="" title="iphone 7回收价格评估"><img
                                    src="${leixing.lxImg}" width="180"
                                    height="135" alt="iphone 7闲置回收价格评估"/></a></div>
                             
                            <p class="name">${leixing.lxName}</p>
                            <!--<p class="price">回收价：<em>￥3080</em></p>-->
                            <p class="pinggu"><a href="<%=basePath %>/phone/shuxing?lxId=${leixing.lxId}" title="在线评估iphone 7回收价格"><!--去评估--></a>
                            </p>
                ...
                <div class="clear"></div>
                <!-- <div class="pageStr">
                    <div class="ihuigo_page"><span class="cur_link">1</span><span><a
                            href="ershoushouji/2.html">2</a></span><span><a
                            ...
                            href="ershoushouji/232.html">尾页</a></span></div>
                </div> -->
            </div>
        </div>
        <div class="clear"></div>
