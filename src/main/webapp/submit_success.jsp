	 ...
	 <div class="tyd_box">
	  <div class="tyd_box_c">
		...
		<div class="tyd_box_content" style="width:612px;overflow:auto; height:450px;">
			<iframe id="Loading_child_iframe_id" name="iframe_id" width="612" height="450" border="0" frameborder="0" src="./订单提交-回购网 - 手机回收网 _ 二手手机交易 _ 笔记本回收 _ 平板回收_files/saved_resource.html"></iframe>
		</div>
	  </div>
	</div>
</div>
    ...
    <div class="shortcut-left">
      <ul>
        ...
        <span id="selectcity_new">
          <script rel="nofollow" src="./订单提交-回购网 - 手机回收网 _ 二手手机交易 _ 笔记本回收 _ 平板回收_files/show_city.html" type="text/javascript" language="javascript"></script>深圳市
        </span>
...
<div class="header">
  <div class="page">
    <h1 class="logo"><a href="images/logo.png" width="171" height="43" title="二手手机回收交易网"></a></h1>
...
<!--头部--><script src="js/jquery-1.4.2.js" type="text/javascript"></script>

<script type="text/javascript" src="js/payway.js.下载"></script>
<script type="text/javascript" src="js/order.js.下载"></script>
<script type="text/javascript" src="js/city.js.下载"></script>
<script type="text/javascript" src="js/city_jilian.js.下载"></script>
...
<form name="myFrom" id="myFrom" method="post" action="/order/sub.html">
  ...
  <div class="process_main">
    <div class="sucess">
      <div class="sucess_t">
        <h2>恭喜，您的订单已提交成功！</h2>
        <p>订单号：${orderNum}  您选择的交易方式为
							<em>支付宝交易</em>，回购网将对您的支付宝账号（${aliNum }）创建付款，付款后可在支付宝交易记录中查看本交易
						
		</p>
      </div>
      <div class="tips">
        <p>您享受回购网的<em>72小时价格保护</em>服务</p>
    ...
    <div class="liucheng_btn">
		<a href="<%=basePath%>/show_order.do" class="liucheng_gr">进入个人中心</a>
		<a href="<%=basePath%>/show.do" class="liucheng_jx">继续回购</a>
	</div>
    <div class="localization">
      ...
      <div class="localization_r">
        <p>1、交易过程中，回收价格超过100元，物流费用由回购网限额承担（保价、
          包装费除外）：回收价格低于100元，回购网承担限额内一半邮费</p>
        <p>2、顺丰支持邮费到付，其他快递不支持。另外，回购网建议尽量不要采用EMS邮寄。</p>
        <p>3、回购网拒收非法所得的产品，一经发现，将拒绝回收，退货运费由用户自己承担</p>
...
<div class="share_box">
  ...
  <div class="share_img"><img src="./订单提交成功-回购网 - 手机回收网 _ 二手手机交易 _ 笔记本回收 _ 平板回收_files/HG171228648611.html"></div>
...
<script type="text/javascript">
    ...
    <div class="clear"></div>
	    <div class="statist">
      <p><em>Copyright Reserved 2009-2016 @</em> 回购网ihuigo.com版权所有 <span><a href="http://www.miibeian.gov.cn/" target="_blank" rel="nofollow">粤ICP备10071783号</a> <script rel="nofollow" src="./订单提交成功-回购网 - 手机回收网 _ 二手手机交易 _ 笔记本回收 _ 平板回收_files/stat.php" language="JavaScript"></script><script src="./订单提交成功-回购网 - 手机回收网 _ 二手手机交易 _ 笔记本回收 _ 平板回收_files/core.php" charset="utf-8" type="text/javascript"></script><a href="http://www.cnzz.com/stat/website.php?web_id=4678782" target="_blank" title="站长统计">站长统计</a> <script>
var _hmt = _hmt || [];
(function() {
...
<script type="text/javascript" src="css/alert_zhe.js(1)"></script>
	 ...
	 <div class="tyd_box">
	  <div class="tyd_box_c">
		...
		<div class="tyd_box_content" style="width:524px;height:529px; overflow:hidden">
			<iframe id="Loading_server_iframe_id" name="iframe_id" width="524" height="529" border="0" frameborder="0" src="./订单提交成功-回购网 - 手机回收网 _ 二手手机交易 _ 笔记本回收 _ 平板回收_files/saved_resource(1).html"></iframe>
		</div>
	  </div>
	</div>
</div>
	 ...
	 <div class="tyd_box">
	  <div class="tyd_box_c">
		...
		<div class="tyd_box_content" style="width:502px;overflow:auto; height:570px;;">
			<iframe id="Loading_child_members_iframe_id" name="iframe_id" width="502" height="570px;" border="0" frameborder="0" src="./订单提交成功-回购网 - 手机回收网 _ 二手手机交易 _ 笔记本回收 _ 平板回收_files/saved_resource(2).html"></iframe>
		</div>
	  </div>
	</div>
</div>
<div id="mbDIV_members" style="display: none; height: 1192px;"></div>
<script type="text/javascript">
function login_pop(){
